...
namespace WebBeds.Indexing
{
    public static class Util
    {
        ...
        public static void UnionArraysInline(ref ushort[] set1, ushort[] set2)
        {
            ...
            buffer = new ushort[length1 + length2];
            var s1 = set1[k1];
            var s2 = set2[k2];
            int size = 0;
        ...
        public static void AndNotArraysInline(ref ushort[] set1, ushort[] set2)
        {
            var pos = 0;
            int k1 = 0, k2 = 0;
            var length1 = set1.Length;
